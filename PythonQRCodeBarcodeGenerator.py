...
def CreateWidgets():
    label = Label(text="CODE TEXT : ", bg="darkseagreen4")
...
def QRCodeBarcodeGenerate():
    ...
    if QrBarcodeSelection == "qrcode":
        ...
        if QrBarcodeString != '':
            ...
            BarcodePath = 'YOUR DESTINATION PATH'
